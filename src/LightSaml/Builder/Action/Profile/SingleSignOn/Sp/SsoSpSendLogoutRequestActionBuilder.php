...
class SsoSpSendLogoutRequestActionBuilder extends AbstractProfileActionBuilder
{
    protected function doInitialize()
    {
        ...
        $this->add(new CreateLogoutRequestAction(
            $this->buildContainer->getSystemContainer()->getLogger(),
            $this->buildContainer->getPartyContainer(),
            $this->buildContainer->getStoreContainer()
        ));
